...
<head>
  ...
  <script type="text/javascript">
    window.applicationId =
      <?php
        echo "\"";
        echo ($_ENV["USE_PROD"] == 'true')  ?  $_ENV["sq0idp-L3Zq8zqhsQ4Lfebheybxyg"]
                                            :  $_ENV["sandbox-sq0idp-L3Zq8zqhsQ4Lfebheybxyg"];
        echo "\"";
      ?>;
    window.locationId =
    <?php
      echo "\"";
      echo ($_ENV["USE_PROD"] == 'true')  ?  $_ENV["X6KVEGZEKC0SE"]
                                          :  $_ENV["CBASEEwMbjTpERdIk6bLmlVLElcgAQ"];
      echo "\"";
    ?>;
  </script>
